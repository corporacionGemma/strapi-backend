...
export interface ApiConcreNosotroConcreNosotro extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'CONCRE_Nosotro';
    pluralName: 'concre-nosotros';
    singularName: 'concre-nosotro';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    items: Schema.Attribute.Component<'reutilizable.titulo', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::concre-nosotro.concre-nosotro'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiConcreProyectoConcreProyecto
  extends Struct.CollectionTypeSchema {
  collectionName: 'concre_proyectos';
  info: {
    displayName: 'CONCRE_Proyecto';
    pluralName: 'concre-proyectos';
    singularName: 'concre-proyecto';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    banner: Schema.Attribute.Component<'reutilizable.titulo', false>;
    card: Schema.Attribute.Component<'reutilizable.card', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::concre-proyecto.concre-proyecto'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiGhgContactFormGhgContactForm
  ...
  info: {
    displayName: 'GHG-Contact-Form';
    pluralName: 'ghg-contact-forms';
    singularName: 'ghg-contact-form';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ghg-contact-form.ghg-contact-form'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiGhgGeneralGhgGeneral extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'GHG_General';
    pluralName: 'ghg-generals';
    singularName: 'ghg-general';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiGhgHomeGhgHome extends Struct.SingleTypeSchema {
  collectionName: 'ghg_homes';
  info: {
    displayName: 'GHG_Home';
    pluralName: 'ghg-homes';
    singularName: 'ghg-home';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ghg_comercial: Schema.Attribute.Component<'reutilizable.titulo', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ghg_form: Schema.Attribute.Component<'reutilizable.titulo', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    GHG_navbar: Schema.Attribute.Component<'reutilizable.navbar', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ghg_principal: Schema.Attribute.Component<'reutilizable.titulo', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ghg_quienes_somos: Schema.Attribute.Component<
      'reutilizable.titulo',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    ghg_servicios: Schema.Attribute.Component<'reutilizable.titulo', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ghg_transformando: Schema.Attribute.Component<
      'reutilizable.titulo',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
